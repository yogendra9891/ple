...
<div id="content">
<script>
var cuser = "<?php echo $this->Session->read('UserData.userName');?>";
var current_username = "<?php echo $this->requestAction('chats/getUserName');?>";
function currentTime(){
var ctime = "<?php echo time();?>";
return ctime;
}
</script>
