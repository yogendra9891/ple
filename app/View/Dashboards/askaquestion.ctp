...
echo $this->Html->script('askquestion', array('inline' => false)); //script for ask a question tree view
...
<ul class="treeview" id="tree">
     ...
     <li class="forHeadings">
          <div class="toAlign">
           <div class="content forModule"><div id="sidetreecontrol"> <a href="?#" id="collapse" class="tobetoggle" title="collapse all">Collapse</a><a href="?#" id="expand" class="tobetoggle tobehide" title="expand all">Expand</a> </div></div>
           <div class="post1">
                 <h3>Posts</h3>
           </div>
           <div class="replies1">
  ...
  <?php foreach ($module_structure as $k=>$module) {
	   if ($k != 'content_id') { ?>
		  <li class="collapsable"><div class="hitarea collapsable-hitarea"></div><span class="toAbsolute forModule"><?php echo $structure_title['title'][$k];?>
			  ...
			  <?php 
			   foreach ($module as $key=>$value) {
			   	if($key != 'content_id') { ?>
				     ...
				     <span class="toAbsolute"><?php echo $structure_title['title'][$key];?>&nbsp;&nbsp;<a href="javascript:void(0);" title="edit" class="editdatesetting" id="edit_<?php echo $key;?>">Edit</a></span>
				     	 <div class="folder">
					           <div class="content toIndent"><?php echo $structure_title['title'][$key];?></div>
					           <div class="post1">
...
<!-- 					                          <input type="text"> -->
					     ...
					     <ul>
					      <?php foreach ($value as $file) { ?>
					  	    <li>
						  	    <div class="content">
	                              <img src="<?php echo $this->webroot.'img/file.gif'; ?>"><?php echo $structure_title['title'][$file]; ?>
			  ...
			  <?php 
			      ...
			      foreach ($value as $file) { ?>
					   ...
					   <div class="singleLi toAlign1">
				           <div class="content"><img src="<?php echo $this->webroot.'img/file.gif'; ?>"><?php echo $structure_title['title'][$file]; ?>
	  ...
	  <?php }  else { foreach ($module as $another_file) {?>
	   <li>
		   <div class="singleLi toAlign">
	           <div class="content"><img src="<?php echo $this->webroot.'img/file.gif'; ?>"><?php echo $structure_title['title'][$another_file];?>
