...
window.onload = function(e){
              ...
              $("#email_chatt").on('click', function(){ //event handling for mail transcript
...
//setInterval(showUsersforInvitation,15000);
    ...
    <input title="Email Chat" id="email_chatt" type="image" src="<?php echo $this->webroot;?>img/email.png" alt='email_chat' style="width: 24px;" />
